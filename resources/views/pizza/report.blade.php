...
<head>
    ...
    <title>Relatório de Pizzas - Sistema Pizzaria</title>
...
<div class="identification-header">PIZZA</div>
    ...
    <tr>
        ...
        <td class="pizza-foto">
            @if($pizza->foto)
                ...
                @php
                    $caminho = str_starts_with($pizza->foto, 'assets/')
                        ? public_path($pizza->foto)
                        : storage_path('app/public/' . $pizza->foto);
